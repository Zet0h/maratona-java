package academy.enzo.maratonajava.exercicios.ex05salario;
...
public class Ex05Salario {
    public static void main(String[] args) {
        ...
        result = salario / salarioMinimo;

        System.out.printf("O usuário recebe %.1f salários minimos %n", result);
